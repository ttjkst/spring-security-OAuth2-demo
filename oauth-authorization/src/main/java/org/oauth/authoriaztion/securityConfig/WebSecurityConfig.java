...
import org.oauth.authoriaztion.authority.WebExpressAutorityVoter;
		...
		public Object postProcess(Object object) {
			...
			if (FilterSecurityInterceptor.class.isAssignableFrom(object.getClass())) {
                ...
                if(accessDecisionManager instanceof AbstractAccessDecisionManager){
                    ((AbstractAccessDecisionManager) accessDecisionManager).getDecisionVoters().add(new WebExpressAutorityVoter());
                }
            }else {
